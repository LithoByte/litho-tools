...
func splashVC() -> UIViewController {
    return SplashViewController.makeFromXib()
}
...
func loginVC() -> UIViewController {
    return LoginViewController.makeFromXib()
}

func signUpVC() -> UIViewController {
    return RegistrationViewController.makeFromXib()
}
...
class RegistrationViewController: LUXRegistrationViewController {}
"""
}
...
<document type="com.apple.InterfaceBuilder3.CocoaTouch.XIB" version="3.0" toolsVersion="13142" targetRuntime="iOS.CocoaTouch" propertyAccessControl="none" useAutolayout="YES" useTraitCollections="YES" useSafeAreas="YES" colorMatched="YES">
    ...
    <objects>
        <placeholder placeholderIdentifier="IBFilesOwner" id="-1" userLabel="File's Owner" customClass="RegistrationViewController" customModule="\(projectLibName)" customModuleProvider="target">
            <connections>
                <outlet property="view" destination="i5M-Pr-FkT" id="sfx-zR-JGt"/>
            </connections>
        </placeholder>
